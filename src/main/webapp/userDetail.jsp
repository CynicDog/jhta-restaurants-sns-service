...
%>
                        <li class="list-group-item d-flex justify-content-between align-items-start">
                            ...
                            <a href="storeDetail.jsp?storeId=<%=store.getId() %>&&fromUserDetails=true"  class="btn btn-light btn-sm my-3 mx-1" >가게 상세</a>
                            <a href="menuRegFormPage.jsp?storeId=<%=store.getId() %>&&fromUserDetails=true"  class="btn btn-light btn-sm my-3 mx-1" >메뉴 등록</a>
                            <a href="deleteStore.jsp?storeId=<%=store.getId() %>"  class="btn btn-danger btn-sm my-3 mx-1" >삭제</a>
                        </li>
<%  
		}   
%>
