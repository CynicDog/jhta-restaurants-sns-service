...
(
	...
	STORE_LATITUDE number(10,6) NOT NULL,
	STORE_LONGITUDE number(10,6) NOT NULL,
...
(
	ID number NOT NULL,
	TIME_CATEGORY char(32),
	TIME_DAY char(8) NOT NULL,
	TIME_OPENTIME varchar2(64) NOT NULL,
	TIME_CLOSETIME varchar2(64) NOT NULL,
	STORE_ID number NOT NULL,
	PRIMARY KEY (ID)
);
