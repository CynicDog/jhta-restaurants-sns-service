...
(
   ID number NOT NULL,
   REVIEW_RATING number(5,2) NOT NULL,
...
-- Alter the precision of the STORE_LATITUDE column
ALTER TABLE STORES MODIFY (STORE_LATITUDE NUMBER(27, 15));

-- Alter the precision of the STORE_LONGITUDE column
ALTER TABLE STORES MODIFY (STORE_LONGITUDE NUMBER(27, 15));
