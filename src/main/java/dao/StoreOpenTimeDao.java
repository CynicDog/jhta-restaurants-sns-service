...
public class StoreOpenTimeDao {
	...
	public void insertStoreOpenTime(StoreOpentime storeOpentime) {
		DaoHelper.update("StoreOpenTimeDao.insertStoreOpenTime", storeOpentime.getCategory(), storeOpentime.getDay(),
				storeOpentime.getOpenTime(), storeOpentime.getCloseTime(), storeOpentime.getStore().getId());
	}

	public void updateStoreOpenTime(StoreOpentime storeOpentime) {
		DaoHelper.update("StoreOpenTimeDao.updateStoreOpenTime", storeOpentime.getId(), storeOpentime.getCategory(),
				storeOpentime.getDay(), storeOpentime.getOpenTime(), storeOpentime.getCloseTime(),
